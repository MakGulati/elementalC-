...
int main()
{
    ...
    char givenChar;
    double *pointerGivenDouble;
    double **pointerPointerGivenDouble;

    pointerGivenDouble = &givenDouble;
    pointerPointerGivenDouble = &pointerGivenDouble;
   ...
   //Use indirection to the get the value stored at the address
    std::cout<< "pointer of givenInt = " << *pointerGivenDouble<<"\n";
    std::cout<< "pointer of pointer of givenInt = " << **pointerPointerGivenDouble<< "\n";
